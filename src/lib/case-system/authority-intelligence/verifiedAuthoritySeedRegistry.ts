    ...
    sourceReferences: [
      {
        ...
        notes: [
          "No resolvable source URL on file. CanLII and the SCC's own decisions site cannot currently be fetched by this project's tooling; pending CanLII API access before this can be promoted to verified.",
        ],
      },
    ],
    createdAt: NOW,
