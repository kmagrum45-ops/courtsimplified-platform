...
const familyTopics = [
  {
    ...
    description:
      "Organize parenting schedules, decision-making responsibility, exchanges, communication issues, and children’s routines.",
    image:
  ...
  },
  {
    ...
    description:
      "Keep track of child support, spousal support, income details, arrears, expenses, and financial disclosure.",
    image:
  ...
  },
  {
    ...
    description:
      "Prepare information about separation dates, agreements, family property, debts, the home, and requested orders.",
    image:
...
const familySteps = [
  "Tell your story once in a guided family intake.",
  "Review a clear summary of the issues, facts, dates, and missing details.",
  "Move into the forms and evidence steps with your case information carried forward.",
  "Keep messages, documents, screenshots, and exhibits organized with the case.",
];
    ...
    <main className="min-h-screen bg-[#f8faf8] text-[#16302b]">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <h1 className="max-w-3xl text-4xl font-bold tracking-tight text-[#10231f] md:text-5xl">
              Get your family court information organized in one place.
            </h1>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-[#4f685f]">
              ...
              CourtSimplified helps you sort the information before moving into
              forms and evidence.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div>
            ...
            <p className="mt-4 max-w-3xl text-base leading-7 text-[#557168]">
              Your family case can stay organized from the first intake through
              the summary, forms, evidence, and final document package.
            </p>
      ...
      <section className="border-t border-[#d9e6df] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-14">
          ...
          <Link
            href="/forms"
            className="mt-6 inline-block rounded-full bg-[#2f7d67] px-6 py-3 text-sm font-semibold text-white hover:bg-[#276a57]"
          >
            Search Family Forms →
          </Link>
        </div>
